...
import com.snk.framework.shiro.service.SysPasswordService;
...
public class SysUserController extends BaseController
{
    ...
    public TableDataInfo list(SysUser user)
    {
        ...
        return getDataTable(ShiroUtils.getSysUser().isAdmin() ? list.stream().filter(r -> !r.isAdmin()).collect(Collectors.toList())
                : list.stream().filter(r -> !r.isSnkAdmin()).collect(Collectors.toList()));
    }
    ...
    public String add(ModelMap mmap)
    {
        ...
        mmap.put("roles", ShiroUtils.getSysUser().isAdmin() ? roles.stream().filter(r -> !r.isAdmin()).collect(Collectors.toList())
                : roles.stream().filter(r -> !r.isSnkAdmin()).collect(Collectors.toList()));
