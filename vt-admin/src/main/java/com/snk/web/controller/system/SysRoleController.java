...
public class SysRoleController extends BaseController
{
    ...
    public TableDataInfo list(SysRole role)
    {
        ...
        return getDataTable(ShiroUtils.getSysUser().isAdmin() ? list.stream().filter(r -> !r.isAdmin()).collect(Collectors.toList()) : list.stream().filter(r -> !r.isSnkAdmin()).collect(Collectors.toList()));
    }
