...
public class DictUtils
{
    ...
    {
        return getDictLabel(dictType, dictValue, SymbolConstants.COMMA);
    }
    ...
    {
        return getDictValue(dictType, dictLabel, SymbolConstants.COMMA);
    }
     ...
     * @return 字典标签
     */
    public static String getDictLabelByType(String dictType, String separator)
    {
