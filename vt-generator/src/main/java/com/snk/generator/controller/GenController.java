package com.snk.generator.controller;
...
import com.snk.common.core.domain.CxSelect;
...
import com.snk.generator.service.IGenTableColumnService;
...
public class GenController extends BaseController
{
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"snk.zip\"");
